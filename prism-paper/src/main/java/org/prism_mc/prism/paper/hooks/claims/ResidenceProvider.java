...
/**
 * Claims provider for Residence.
 */
public class ResidenceProvider implements ClaimsProvider {

    @Override
    public ClaimPlugin getClaimPlugin() {
        return ClaimPlugin.RESIDENCE;
    }
    ...
    public boolean hasRegionAccess(Player player, Location location) {
        ...
        // No residence at location
        if (residence == null) {
            return false;
        }
        
        // Check if player is owner
        return residence.getOwner().equals(player.getName());
    }
}
